    ...
    <Computer>
      <>
        <p>
          ...
          watch
          {' '}
          <a href="https://www.youtube.com/watch?v=QoZ8pccsYo4&ab_channel=LeoIsikdogan" target="_blank" rel="noreferrer">this video</a>
          .
        ...
        <p>
          ...
          like
          {' '}
          <a href="https://code.org" target="_blank" rel="noreferrer">code.org</a>
          {' '}
          and
          <a href="https://scratch.mit.edu" target="_blank" rel="noreferrer">scratch.mit.edu</a>
          .
        </p>
      </>
    </Computer>
