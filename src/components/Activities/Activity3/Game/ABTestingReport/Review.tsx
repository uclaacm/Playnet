  ...
  [VARIABLES.SAME_CREATOR]: {
    ...
    2: {
      ...
      [weightDifference.high]: ['haaaa youtube thinks i only like marshmello or smthg 🤦🏽‍♀️',
        'i mean i do like anson seabara but like chill man',
        'Hi Youtube, would you mind possibly showing me new creators also? Spotify does a good job with that.',
      ],
    },
    3: {
      ...defaultRatingReview,
  ...
  [VARIABLES.SUBSCRIBED]: {
    ...
    2: {
      ...
      [weightDifference.low]: ['why do you think i subscribed to those channels youtube? i want to see their videos! 🤦🏼‍♂️😠',
        'not much to say, a lil disappointed in not really seeing my subbs',
        'wait i thought subs means that you\'ll see the content more? - feelin a lil confused 🤔',
      ],
      [weightDifference.high]: ['meh ig could should me more cool things but i guess my subs are good too 😶🙃',
        'See my website for a complete review of Youtube\'s reccomendation system. Seeing too much subscribed content lately. Youtube needs to step up their game.',
        'i hAVe SUBscRiBEd to fortniteXXGamerXXPro and nOW i cANT get RID OF thEM AH',
      ],
    },
    3: {
      ...defaultRatingReview,
