...
export function GameIntroSlide1(): JSX.Element {
  return <img src={WelcomeToTeam} alt='Woman saying welcome to the team!' style={{ height: "80%" }} />
}
...
export function GameIntroSlide2(): JSX.Element {
  return <div className='grid'>
    <section>
    <BouncingArrow />
    <img className={'half'} src={CatVideos} alt='Cat video playing and next recommended are cat videos' />
    </section>
